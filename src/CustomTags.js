  ...
  render() {
    ...
    return (
      <div className={this.state.classNames.tags}>
        <div className={this.state.classNames.selected} style={styles.wrapper}>
          {tagItems}
...
export default DragDropContext(HTML5Backend)(CustomTags);

/*
module.exports = {
  WithContext: DragDropContext(HTML5Backend)(CustomTags),
  WithOutContext: CustomTags,
  Keys: Keys,
};*/

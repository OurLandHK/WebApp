...
let constant = {
  ...
  updateCommentApproveStatusSuccess: "駁回社區事件成功",
  updateCommentApproveStatusFailure: "駁回社區事件失敗",
  approveMessageSuccess: "接納社區事件成功",
